package matrixMenuDriven;

import java.util.Scanner;

public class MatrixMenuDriven {

    /* Here I am using addition matrix, subtraction matrix and multiplication for user choice
        User get menu driven system and choose multiplication or other function
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.print("\nEnter 1: Matrix Addition\n Enter 2: Matrix Subtraction\n Enter 3: Matrix Multiplication\n Enter 4: Quit\n");
